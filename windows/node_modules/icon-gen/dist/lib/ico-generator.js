...
class ICOGenerator {
  ...
  static generate(images, dir, options, logger) {
    return new Promise(resolve => {
      ...
      const dest = _path2.default.join(dir, options.names.ico + FILE_EXTENSION);
      const targets = _util2.default.filterImagesBySizes(images, _util2.default.checkImageSizes(REQUIRED_IMAGE_SIZES, options, 'ico'));
